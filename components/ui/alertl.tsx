...
export default function Alert({ title, description, acao, close, finish }: BtnPopUpProps) {
    ...
    return (
        <div className="absolute flex flex-col justify-around items-center left-72 top-48 z-10 p-2 w-96 h-48 bg-zinc-300/90 shadow-md shadow-zinc-500 border-2 border-zinc-300 rounded-2xl">
