      ...
      <div className="flex justify-end gap-9 w-full h-[80%]">
        <div className="relative w-[82%] h-[100%] rounded-md p-1 bg-zinc-50">
          ...
          <ScrollArea className="w-full h-full">
            {bulk.map(({ carga }, key) => (
              carga.bulkState !== 'Entrada' && carga.bulkState !== 'recebendo' && (                
                <div key={key} className="flex items-center w-full h-6 rounded-[4px] bg-zinc-200 hover:bg-zinc-300 mb-[1.50px]">
                  <ul className="grid grid-cols-7 gap-10 text-[15px] w-full">
                    ...
                    <li className="col-start-4 place-self-center">{fullDatePrint(carga.bulkConfDate)}</li>
                    <li className="col-start-5 place-self-center">{hourPrint(carga.bulkConfDate)}</li>
                    <li className="col-start-6 place-self-center">
                      <Timer props={{ date: carga.bulkConfDate, k: key }} />
                    </li>
