...
export default function Page() {
  return (
    <section className="flex items-center w-full h-full gap-1 bg-gray-50 p-2 ">
        <div className="flex flex-col justify-between text-center w-full lg:w-70 h-full px-6 py-4 bg-zinc-100 rounded-2xl border-2 border-zinc-300">
            <h1 className="text-4xl font-bold p-2 rounded-[4px] text-zinc-500">PCE Tools</h1>
            <div className="lg:hidden flex flex-col gap-4 h-48">
        ...
        <div className="hidden lg:flex lg:flex-col justify-center gap-8 w-full h-[97vh] text-center bg-zinc-300 rounded-2xl border-2 border-zinc-400">
            <div>
              <h1 className="text-4xl font-bold">Bem-vindo às Ferramentas PCE</h1>
              <p className="text-lg">Sua solução completa para todas as tarefas relacionadas a PCE.</p>
            </div>
