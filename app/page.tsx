...
export default function Page() {
  return (
    <section className="flex items-end gap-1 bg-gray-50 p-2">
        ...
        <div className="flex flex-col justify-center text-justify gap-4 w-full h-[97vh] bg-zinc-300 rounded-2xl border-2 border-zinc-400">
            <div>
